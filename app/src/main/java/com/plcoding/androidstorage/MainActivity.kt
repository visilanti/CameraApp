...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //mendapakan dan melanjutkan hasil permission
...
//melakukan pengecekan apakah kita memiliki permission atau tidak dan akan mengupdate variable permission di atas
    ...
    //saving photos in external storage
